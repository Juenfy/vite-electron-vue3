...
import { routerPushOrOpenWindow } from '../utils/help';
</script>

<template>
    <div class="flex-1 overflow-x-hidden overflow-y-scroll bg-blue-500">
        <button type="button" class="green-btn" @click="routerPushOrOpenWindow('test')">打开新的测试窗口</button>
        <h1>App Default Protocol Demo</h1>

        <p>
            The protocol API allows us to register a custom protocol and
            intercept existing protocol requests.
        </p>
        <p>
            These methods allow you to set and unset the protocols your app
            should be the default app for. Similar to when a browser asks to be
            your default for viewing web pages.
        </p>

        <p>
            Open the
            <a href="https://www.electronjs.org/docs/latest/api/protocol">full protocol API documentation</a>
            in your browser.
        </p>
        ...
        <p>
            ...
            for <code>electron-fiddle://</code>. The demo button above will
